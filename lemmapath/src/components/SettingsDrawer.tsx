  ...
  return (
    <div className="panel" style={{ padding: 16, marginTop: 12 }}>
      ...
      <div className="row">
        ...
        <select className="btn" value={ds.theme} onChange={(e) => props.onUpdate({ theme: e.target.value as any })}>
        ...
        <select className="btn" value={ds.rtlMode} onChange={(e) => props.onUpdate({ rtlMode: e.target.value as any })}>
